...
/// Adds pattern-matching-related methods to [MyError].
extension MyErrorPatterns on MyError {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_MyError value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _MyError() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(ErrorType type, String message)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
